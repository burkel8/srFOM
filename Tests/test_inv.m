...
%% %%%%%%%%% User Inputs %%%%%%%%%%%%%%
max_it = 200; % The maximum number of iterations of the methods 
...
tol = 10e-30; % The error tolerance used to define convergence.

k = 20;       % The dimension of the recycling subspace used by rfom and srfom

t = 10;        % Arnoldi truncation parameter for the truncated Arnoldi method
